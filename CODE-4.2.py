...
f_Tasmax = r"E:\mingan_results\UKESM\1Tmax_no_rad.nc"
Tmax = xr.open_dataset(f_Tasmax).tasmax
f_Tasmin = r"E:\mingan_results\UKESM\1Tmin_no_rad.nc"
Tmin = xr.open_dataset(f_Tasmin).tasmin
...
# 保存
output_file = "E:\\PET_results\\UKESM\\1PET_tas_1.nc"
